import { risStationsConfiguration } from '#/server/external/config.js';
import {
  StopPlaceKeyFilter,
  StopPlacesApi,
  StopPlaceSearchGroupByKey,
} from '#/server/external/generated/risStations/index.js';
import { TransportType } from '#/server/external/types.js';
